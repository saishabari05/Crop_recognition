...
# Previous dynamic loader with fallback kept for reference.
# import hashlib
# import os
...
_MODEL: Optional[Callable[[bytes], dict]] = None


def _load_model() -> Callable[[bytes], dict]:
    module = importlib.import_module("model_integration")
